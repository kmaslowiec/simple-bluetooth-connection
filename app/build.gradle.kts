...
android {
    namespace = "com.example.simplebluetoothconnection"
    compileSdk = 34
    defaultConfig {
        applicationId = "com.example.simplebluetoothconnection"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        testInstrumentationRunner = "com.example.simplebluetoothconnection.CustomTestRunner"
        vectorDrawables {
